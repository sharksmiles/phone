<template>
	<view class="container">
		...
		<u-form :model="form" ref="uForm" label-position="top" :label-style="{fontSize:'30rpx',fontWeight:'bold'}"><u-form-item label="支付宝实名" prop="aliname"><u-input v-model="form.aliname" placeholder="请输入支付宝实名" /></u-form-item>
			<u-form-item label="支付宝账户"  prop="alimobile"><u-input v-model="form.alimobile" placeholder="请输入支付宝账户" /></u-form-item>
			...
			<u-form-item label="验证码"  prop="code">
				...
				<block solt="right">
					...
					<u-button size="mini" @tap="getCode" type="success" style="background-color: #61c9f0;">{{tips}}</u-button>
				</block>
			</u-form-item>
		</u-form>
...
<script>
	import { sendCode, bindAlipay } from "@/api/cash.js"
	export default {
		data() {
			return {
				form: {},
