<template>
	<view>
		<view class="container">
			<scroll-view scroll-y class="list container-list"  :scroll-with-animation="true" :scroll-top="scrollTop" :scroll-into-view="scrollToViewID">
				<view id="chat-box">
					<block v-if="account">
			...
			<view class="bottom-block">
				<view class="bottom-view">
					<view class="input">
						<view class="">
							<textarea auto-height v-model="value" placeholder="请输入文本" bindinput="getInput" maxlength="1000"/>
						</view>
...
<script>
	...
	import { getMessage, send as sendApi } from "@/api/customer.js"
	import { detail } from "@/api/index.js"
	import { examine } from '@/api/common';
	export default {
		computed: {
		    ...mapState(['user']),
		}, 
			...
			safariHacks() {
				let convertStyle = function(){
					setTimeout(function(){
						...
						document.querySelector('.container-list').style.setProperty("height", "calc("+ windowsVH + " - " + bottomHeight + ")", "important");
					},1000)
				} 
